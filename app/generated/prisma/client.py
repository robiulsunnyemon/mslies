...
SCHEMA_PATH = Path('D:/mslies/backend/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    def __init__(
        ...
        *,
        ...
        self.otp = actions.OTPActions[models.OTP](self, models.OTP)
        ...
        self.mcqset = actions.MCQSetActions[models.MCQSet](self, models.MCQSet)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'D:/mslies/backend/schema.prisma',
        }
