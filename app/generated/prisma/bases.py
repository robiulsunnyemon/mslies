...
class BaseOTP(_PrismaModel):
    __prisma_model__: ClassVar[Literal['OTP']] = 'OTP'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.OTPActions[_PrismaModelT]':
        from .client import get_client

        return actions.OTPActions[_PrismaModelT](client or get_client(), cls)
...
class BaseMCQSet(_PrismaModel):
    __prisma_model__: ClassVar[Literal['MCQSet']] = 'MCQSet'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MCQSetActions[_PrismaModelT]':
        from .client import get_client

        return actions.MCQSetActions[_PrismaModelT](client or get_client(), cls)
